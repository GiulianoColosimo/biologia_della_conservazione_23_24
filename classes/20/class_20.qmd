...
subtitle: "Class 20 - Climate change"
date: "2024-05-30"
...
-   While this still holds true, climate change is expected to function as a new as well as an intensifier of already existing threats.
...
-   Climate change is a problem right now [@Molina2014], so we do not have to wait for the future scenarios. The speed of contemporary changes is faster than most of the past events and is actively challenging the effectiveness of twenty century conservation [@VanDyke2020].

. . .

> ...the stated purpose of the Prince Albert National Park is to protect for all time the ecological integrity of a natural area of Canadian significance representative of the souther boreal forest and plateau...Yet, all six vegetation change scenarios examined projected the evnetual loss of boreal forest in this park suggesting that the park's mandate would be untenable in the long term [@Lovejoy2008].
...
-   This absorption creates an additional net influx of energy to the earth.
...
-   Of these, $CO_2$, through the burning of fossil fuel, is the one increasing the most and having the largest effect of the absorption of energy, as in normal conditions it contributes for about $26\%$ of the warming effect [@Kiehl1997].
...
![The Holdridge life zones system. Image adapted from @Lugo1999](./class_20_10.png)
...
-   *Vulnerability* to climate change is defined as the extant to which a species or population is threatened with decline, reduced fitness, genetic loss of extinction due to climate change as a function of three primary components: exposure, sensitivity or adaptive capacity.

. . .

-   **Exposure** is defined as the extant of climate change likely to be experienced by a species or locale [@Dawson2011].
...
-   **Sensitivity** is defined as the degree to which the survival, persistence, fitness, performance, or regeneration of a species or population is dependent on the prevailing climate, particularly on those variables that are more likely to change in the near future [@Dawson2011; @VanDyke2020].
...
-   Finally, **adaptive capacity** is the last component of species vulnerability to climate changes.
