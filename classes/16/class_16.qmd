...
-   The variable (or variables) with the greatest proportional effect on values of $\lambda$ (i.e., the most elastic variables) are also the ones that should be considered more carefully for management.
